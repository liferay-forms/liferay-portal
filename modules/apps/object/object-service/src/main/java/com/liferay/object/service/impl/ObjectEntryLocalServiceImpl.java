...
public class ObjectEntryLocalServiceImpl
	...
	public void deleteSystemObjectExtendedProperties(
		...
		Map<String, Serializable> systemObjectExtendedProperties =
			getSystemObjectExtendedProperties(objectDefinition, primaryKey);
		...
		_deleteFileEntries(
			Collections.emptyMap(), objectDefinition.getObjectDefinitionId(),
			systemObjectExtendedProperties);
	}
	...
	public Map<String, Object> getSystemModelAttributes(
		...
		modelAttributes.putAll(
			objectEntryLocalService.getSystemObjectExtendedProperties(
	...
	@Override
	public Map<String, Serializable> getSystemObjectExtendedProperties(
			ObjectDefinition objectDefinition, long primaryKey)
		throws PortalException {

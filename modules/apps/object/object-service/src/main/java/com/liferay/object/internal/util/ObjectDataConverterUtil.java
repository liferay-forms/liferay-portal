...
public class ObjectDataConverterUtil {
	...
	private static Map<String, Object> _convertObjectEntryPayloadJSONObject(
		...
		Map<String, Object> objectEntryModelAttributes =
			objectEntryJSONObject.toMap();

		Map<String, Object> objectEntryValues =
			(Map<String, Object>)objectEntryModelAttributes.get("values");

		if (objectEntryValues != null) {
			objectEntryModelAttributes.putAll(objectEntryValues);

			objectEntryModelAttributes.remove("values");
		}

		objectEntryModelAttributes.put(
			"currentUserId", payloadJSONObject.get("userId"));

		return objectEntryModelAttributes;
	}

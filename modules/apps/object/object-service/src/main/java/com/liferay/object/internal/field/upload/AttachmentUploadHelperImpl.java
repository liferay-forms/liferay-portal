...
package com.liferay.object.internal.field.upload;
 ...
 */
@Component(immediate = true, service = AttachmentUploadHelper.class)
public class AttachmentUploadHelperImpl implements AttachmentUploadHelper {
	...
	public Folder getFolder(
		...
		Repository repository = _getRepository(
			...
			objectFieldRenderingContext.getPortletId(), serviceContext);
		...
		return _getFolder(
			...
			repository.getRepositoryId(), serviceContext);
	}
	...
	private Folder _getFolder(
		...
		try {
			...
			return _addFolder(userId, repositoryId, serviceContext);
		}
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AttachmentUploadHelperImpl.class);

...
public class ObjectActionPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newObjectAction.setCondition(RandomTestUtil.randomString());
		...
		Assert.assertEquals(
			existingObjectAction.getCondition(),
			newObjectAction.getCondition());
		Assert.assertEquals(
	...
	protected OrderByComparator<ObjectAction> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			...
			true, "active", true, "condition", true, "description", true,
			"name", true, "objectActionExecutorKey", true,
	...
	protected ObjectAction addObjectAction() throws Exception {
		...
		objectAction.setCondition(RandomTestUtil.randomString());

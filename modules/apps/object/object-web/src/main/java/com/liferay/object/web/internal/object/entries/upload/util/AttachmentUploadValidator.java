 ...
 */
@Component(service = AttachmentUploadValidator.class)
public class AttachmentUploadValidator {

	public String[] getFileExtensions(long objectFieldId) {
	...
	public void validateFileExtension(String fileName, long objectFielId)
		...
		for (String fileExtension :
				Arrays.asList(getFileExtensions(objectFielId))) {

			if (StringUtil.equalsIgnoreCase(
					FileUtil.getExtension(fileName),
					StringUtil.trim(fileExtension))) {

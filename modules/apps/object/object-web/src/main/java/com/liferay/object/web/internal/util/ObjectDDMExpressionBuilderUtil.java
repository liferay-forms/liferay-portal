	...
	public static List<Map<String, Object>> getDDMExpressionBuilderElements(
		...
		return Arrays.asList(
			_getDDMExpressionBuilderElement(
				...
				"fields", locale),
			_getDDMExpressionBuilderElement(
				DDMExpressionOperator.getItems(locale), "operators", locale),
			_getDDMExpressionBuilderElement(
				DDMExpressionFunction.getItems(locale), "functions", locale));
	}

	private static Map<String, Object> _getDDMExpressionBuilderElement(

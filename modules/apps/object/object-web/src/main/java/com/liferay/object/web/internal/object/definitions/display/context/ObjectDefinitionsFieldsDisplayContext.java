...
import com.liferay.object.web.internal.configuration.activator.FFAttachmentBusinessTypeConfigurationActivator;
...
public class ObjectDefinitionsFieldsDisplayContext {
	...
	public ObjectDefinitionsFieldsDisplayContext(
		FFAttachmentBusinessTypeConfigurationActivator
			ffAttachmentBusinessTypeConfigurationActivator,
		...
		_ffAttachmentBusinessTypeConfigurationActivator =
			ffAttachmentBusinessTypeConfigurationActivator;
		...
		for (ObjectFieldBusinessType objectFieldBusinessType :
			...
			if (!objectFieldBusinessType.isVisible() ||
				(StringUtil.equals(
				 ...
				 !_ffAttachmentBusinessTypeConfigurationActivator.enabled())) {
	...
	private final FFAttachmentBusinessTypeConfigurationActivator
		_ffAttachmentBusinessTypeConfigurationActivator;

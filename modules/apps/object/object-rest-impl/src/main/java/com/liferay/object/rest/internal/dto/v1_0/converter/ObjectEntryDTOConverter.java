...
public class ObjectEntryDTOConverter
	...
	public ObjectEntry toDTO(
		...
		if (uriInfo == null) {
			return _toDTO(dtoConverterContext, objectEntry, 1);
		}

		MultivaluedMap<String, String> queryParameters =
			uriInfo.getQueryParameters();

		int nestedFieldsDepth = GetterUtil.getInteger(
			queryParameters.getFirst("nestedFieldsDepth"), 1);

		if (nestedFieldsDepth >
		...
		return _toDTO(dtoConverterContext, objectEntry, nestedFieldsDepth);
	}

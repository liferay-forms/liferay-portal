...
public class DDMFormInstanceStatusUtilTest extends PowerMockito {
	...
	public void testFormExpired() throws Exception {
		...
		Assert.assertTrue(
			DDMFormInstanceStatusUtil.isFormExpired(
	...
	public void testFormNotExpiredWithInexistentForm() throws Exception {
		Assert.assertFalse(DDMFormInstanceStatusUtil.isFormExpired(null, null));
	}

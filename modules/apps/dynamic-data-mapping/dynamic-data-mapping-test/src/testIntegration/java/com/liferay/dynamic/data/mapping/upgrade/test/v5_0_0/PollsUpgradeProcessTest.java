...
package com.liferay.dynamic.data.mapping.upgrade.test.v5_0_0;
...
public class PollsUpgradeProcessTest {
	...
	@Test
	public void testPollsUpgradeProcess() throws Exception {
	...
	private void _setUpPollsUpgrade() {
				...
				public void register(
					...
					for (UpgradeStep upgradeStep : upgradeSteps) {
						...
						if (className.contains(_CLASS_NAME)) {
							_pollsUpgradeProcess = (UpgradeProcess)upgradeStep;
						}
					}
				}
	...
	private UpgradeProcess _pollsUpgradeProcess;

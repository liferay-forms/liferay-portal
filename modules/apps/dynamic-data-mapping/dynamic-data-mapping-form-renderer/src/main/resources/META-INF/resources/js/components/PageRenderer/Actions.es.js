...
export const ActionsProvider = ({children}) => {
	...
	// 		return dispatch({
	// 			payload: {fieldName: hovered.fieldName},
	// 			type: EVENT_TYPES.FIELD_HOVERED,
	// 		});
	// 	}

	// 	dispatch({
	// 		payload: {fieldInstance: hoveredRef.current ?? {}},
...
const Actions = ({activePage, children, expanded, field}) => {
	...
	return (
		...
		>
			{expanded && (
				<div className="ddm-field-actions-container" ref={actionsRef}>
			...
			{/* React.cloneElement passando a ref*/}
			{children}
		</div>
	);
};

...
import com.liferay.dynamic.data.mapping.form.evaluator.internal.function.EnableImageFieldRequiredDescriptionFunction;
...
@Component(
	...
	property = "name=" + EnableImageFieldRequiredDescriptionFunction.NAME,
	service = DDMExpressionFunctionFactory.class
)
public class EnableImageFieldRequiredDescriptionFunctionFactory
	implements DDMExpressionFunctionFactory {

	@Override
	public DDMExpressionFunction create() {
		return new EnableImageFieldRequiredDescriptionFunction(

...
import com.liferay.dynamic.data.mapping.form.evaluator.internal.function.DisplayImageFieldDescriptionRequiredFunction;
...
@Component(
	...
	property = "name=" + DisplayImageFieldDescriptionRequiredFunction.NAME,
	service = DDMExpressionFunctionFactory.class
)
public class DisplayImageFieldDescriptionRequiredFunctionFactory
	implements DDMExpressionFunctionFactory {

	@Override
	public DDMExpressionFunction create() {
		return new DisplayImageFieldDescriptionRequiredFunction(

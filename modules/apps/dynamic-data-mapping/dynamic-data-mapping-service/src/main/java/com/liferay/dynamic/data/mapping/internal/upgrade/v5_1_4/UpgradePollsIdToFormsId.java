...
public class UpgradePollsIdToFormsId extends BasePortletIdUpgradeProcess {
	...
	protected void doUpgrade() throws Exception {
		runSQL(
			StringBundler.concat(
				...
				_OLD_DISPLAY_PORTLET_NAME, "' OR portletId = '",
				_OLD_PORTLET_NAME, "'"));
		runSQL(
			StringBundler.concat(
				"delete from ResourcePermission where name = '",
				_OLD_DISPLAY_PORTLET_NAME, "' OR name = '", _OLD_PORTLET_NAME,
				"'"));
	...
	private static final String _OLD_DISPLAY_PORTLET_NAME =

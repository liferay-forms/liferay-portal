 ...
 */
public class PollsUpgradeProcess extends UpgradeProcess {

	public PollsUpgradeProcess(
	...
	private void _upgradePollsQuestion(
		...
		_upgradePollsVotes(
			dataJSONObject, ddmFormFieldOptionsValues, questionId, structureId,
			structureVersionId, ddmFormField.getName(),
			String.valueOf(ddmFormField.getProperty("instanceId")));
	...
	private void _upgradePollsVotes(
			JSONObject dataJSONObject,
			Map<Long, String> ddmFormFieldOptionsValues, long questionId,
			long structureId, long structureVersionId, String fieldName,
			String instanceId)
		throws Exception {
